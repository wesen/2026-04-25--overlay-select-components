...
- [x] Capture element metadata: bounding box, outerHTML, innerHTML, textContent, classList
- [x] Capture computed CSS: filter meaningful non-default styles
- [x] Generate smart unique selector: data-attr > class > nth-child fallback
- [x] Implement chrome.storage.local persistence for selections across page navigations
